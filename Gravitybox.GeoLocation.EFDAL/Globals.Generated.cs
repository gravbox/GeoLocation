...
namespace Gravitybox.GeoLocation.EFDAL
{
	...
	internal static partial class DBHelper
	{
		...
		{
			return GetConnection(Gravitybox.GeoLocation.EFDAL.GeoLocationEntities.GetConnectionString());
		}
	...
	/// </summary>
	public partial interface IBusinessObject : Gravitybox.GeoLocation.EFDAL.IReadOnlyBusinessObject
	{
		/// <summary>
...
namespace Gravitybox.GeoLocation.EFDAL.EventArguments
{
...
namespace Gravitybox.GeoLocation.EFDAL.Exceptions
{
