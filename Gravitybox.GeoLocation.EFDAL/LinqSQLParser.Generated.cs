...
using Gravitybox.GeoLocation.EFDAL.Exceptions;
		...
		where K : class, IBusinessObjectLINQQuery
	{
			...
			)
		{
			if (string.IsNullOrEmpty(connectionString))
				connectionString = Gravitybox.GeoLocation.EFDAL.GeoLocationEntities.GetConnectionString();
			...
			)
		{
			return UpdateData(
				...
				getField,
				hasModifyAudit,
				Gravitybox.GeoLocation.EFDAL.GeoLocationEntities.GetConnectionString());
		}
