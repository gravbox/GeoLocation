...
namespace Gravitybox.GeoLocation.EFDAL
{
	...
	public static partial class GeoLocationEntitiesExtensions
	{
		...
		private static IQueryable<T> GetInclude<T, R>(this IQueryable<T> item, Expression<Func<R, Gravitybox.GeoLocation.EFDAL.IContextInclude>> query)
			where T : BaseEntity
			where R : IContextInclude
		{
		...
		public static System.Type GetFieldType(this Gravitybox.GeoLocation.EFDAL.GeoLocationEntities context, Enum field)
		{
			...
			if (field is Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants)
				return Gravitybox.GeoLocation.EFDAL.Entity.Zip.GetFieldType((Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants)field);
		...
		public static Gravitybox.GeoLocation.EFDAL.IMetadata GetMetaData(this Gravitybox.GeoLocation.EFDAL.IReadOnlyBusinessObject entity)
		{
			...
			return Activator.CreateInstance(t) as Gravitybox.GeoLocation.EFDAL.IMetadata;
		}
		...
		public static System.Collections.ObjectModel.ObservableCollection<T> AsObservable<T>(this System.Collections.Generic.IEnumerable<T> list)
			where T : Gravitybox.GeoLocation.EFDAL.IReadOnlyBusinessObject
		{
		...
		public static void Delete<T>(this System.Data.Entity.DbSet<T> entitySet, Expression<Func<T, bool>> where)
			where T : class, Gravitybox.GeoLocation.EFDAL.IBusinessObject, new()
		{
		...
		public static void Delete<T>(this System.Data.Entity.DbSet<T> entitySet, Expression<Func<T, bool>> where, QueryOptimizer optimizer)
			where T : System.Data.Entity.DbSet<T>, Gravitybox.GeoLocation.EFDAL.IBusinessObject, new()
		{
