...
namespace Gravitybox.GeoLocation.EFDAL.Entity
{
	...
	[FieldNameConstants(typeof(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants))]
	[System.ComponentModel.DataAnnotations.MetadataType(typeof(Gravitybox.GeoLocation.EFDAL.Entity.Metadata.ZipMetadata))]
	[EntityMetadata("Zip", false, true, true, true, "", true, false, false, "dbo")]
	public partial class Zip : BaseEntity, Gravitybox.GeoLocation.EFDAL.IBusinessObject, System.ComponentModel.INotifyPropertyChanged, System.ComponentModel.INotifyPropertyChanging, System.ICloneable, Gravitybox.GeoLocation.EFDAL.IAuditable, Gravitybox.GeoLocation.EFDAL.IAuditableSet, Gravitybox.GeoLocation.EFDAL.ICreatable
	{
		...
		/// <summary>
		/// Initializes a new instance of the Gravitybox.GeoLocation.EFDAL.Entity.Zip class
		/// </summary>
		public Zip()
		{
		...
		public virtual string City
		{
			...
			set
			{
				if ((value != null) && (value.Length > GetMaxLength(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.City))) throw new Exception(string.Format(GlobalValues.ERROR_DATA_TOO_BIG, value, "Zip.City", GetMaxLength(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.City)));
		...
		public virtual string Name
		{
			...
			set
			{
				if ((value != null) && (value.Length > GetMaxLength(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Name))) throw new Exception(string.Format(GlobalValues.ERROR_DATA_TOO_BIG, value, "Zip.Name", GetMaxLength(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Name)));
		...
		public virtual string State
		{
			...
			set
			{
				if ((value != null) && (value.Length > GetMaxLength(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.State))) throw new Exception(string.Format(GlobalValues.ERROR_DATA_TOO_BIG, value, "Zip.State", GetMaxLength(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.State)));
		...
		public virtual int ZipId
		{
			...
			protected internal set
			{
				...
				var eventArg = new Gravitybox.GeoLocation.EFDAL.EventArguments.ChangingEventArgs<int>(value, "ZipId");
				this.OnPropertyChanging(eventArg);
				if (eventArg.Cancel) return;
		...
		/// </summary>
		[field:NonSerialized]
		public event EventHandler<Gravitybox.GeoLocation.EFDAL.EventArguments.ChangingEventArgs<int>> ZipIdChanging;

		/// <summary>
		/// Raises the OnZipIdChanging event.
		/// </summary>
		protected virtual void OnZipIdChanging(Gravitybox.GeoLocation.EFDAL.EventArguments.ChangingEventArgs<int> e)
		{
		...
		/// </summary>
		public static int GetMaxLength(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants field)
		{
			switch (field)
			{
				case Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.City:
					return 50;
				case Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Latitude:
					return 0;
				case Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Longitude:
					return 0;
				case Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Name:
					return 10;
				case Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Population:
					return 0;
				case Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.State:
					return 50;
				case Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.ZipId:
					return 0;
			}
			return 0;
		}
		...
		{
			return GetMaxLength((Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants)field);
		}
		...
		{
			return typeof(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants);
		}
		...
		/// </summary>
		public static System.Type GetFieldType(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants field)
		{
			if (field.GetType() != typeof(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants))
				throw new Exception("The field parameter must be of type 'Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants'.");

			switch ((Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants)field)
			{
				case Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.City: return typeof(string);
				case Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Latitude: return typeof(double?);
				case Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Longitude: return typeof(double?);
				case Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Name: return typeof(string);
				case Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Population: return typeof(int?);
				case Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.State: return typeof(string);
				case Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.ZipId: return typeof(int);
			}
			return null;
		}
		...
		System.Type Gravitybox.GeoLocation.EFDAL.IReadOnlyBusinessObject.GetFieldType(Enum field)
		{
			...
			return GetFieldType((Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants)field);
		}
		...
		object Gravitybox.GeoLocation.EFDAL.IReadOnlyBusinessObject.GetValue(System.Enum field, object defaultValue)
		{
			if (field.GetType() != typeof(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants))
				throw new Exception("The field parameter must be of type 'Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants'.");
			return this.GetValue((Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants)field, defaultValue);
		}
		...
		void Gravitybox.GeoLocation.EFDAL.IBusinessObject.SetValue(System.Enum field, object newValue)
		{
			if (field.GetType() != typeof(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants))
				throw new Exception("The field parameter must be of type 'Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants'.");
			this.SetValue((Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants)field, newValue);
		}
		...
		void Gravitybox.GeoLocation.EFDAL.IBusinessObject.SetValue(System.Enum field, object newValue, bool fixLength)
		{
			if (field.GetType() != typeof(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants))
				throw new Exception("The field parameter must be of type 'Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants'.");
			this.SetValue((Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants)field, newValue, fixLength);
		}
		...
		{
			return Gravitybox.GeoLocation.EFDAL.Entity.Zip.Clone(this);
		}
		...
		{
			var item = Gravitybox.GeoLocation.EFDAL.Entity.Zip.Clone(this);
			item._zipId = 0;
			return item;
		}
		...
		/// Creates a shallow copy of this object
		/// </summary>
		public static Zip Clone(Gravitybox.GeoLocation.EFDAL.Entity.Zip item)
		{
			var newItem = new Zip();
		...
		/// </summary>
		public virtual object GetValue(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants field)
		{
		...
		/// Gets the value of one of this object's properties.
		/// </summary>
		public virtual object GetValue(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants field, object defaultValue)
		{
			if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.City)
				return this.City;
			if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Latitude)
				return ((this.Latitude == null) ? defaultValue : this.Latitude);
			if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Longitude)
				return ((this.Longitude == null) ? defaultValue : this.Longitude);
			if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Name)
				return this.Name;
			if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Population)
				return ((this.Population == null) ? defaultValue : this.Population);
			if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.State)
				return this.State;
			if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.ZipId)
				return this.ZipId;
			if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.CreatedBy)
				return ((this.CreatedBy == null) ? defaultValue : this.CreatedBy);
			if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.CreatedDate)
				return ((this.CreatedDate == null) ? defaultValue : this.CreatedDate);
			if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.ModifiedBy)
				return ((this.ModifiedBy == null) ? defaultValue : this.ModifiedBy);
			if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.ModifiedDate)
		...
		public virtual void SetValue(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants field, object newValue)
		{
		...
		public virtual void SetValue(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants field, object newValue, bool fixLength)
		{
			if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.City)
			{
				this.City = GlobalValues.SetValueHelperInternal((string)newValue, fixLength, GetMaxLength(field));
			}
			else if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Latitude)
			{
				this.Latitude = GlobalValues.SetValueHelperDoubleNullableInternal(newValue);
			}
			else if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Longitude)
			{
				this.Longitude = GlobalValues.SetValueHelperDoubleNullableInternal(newValue);
			}
			else if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Name)
			{
				this.Name = GlobalValues.SetValueHelperInternal((string)newValue, fixLength, GetMaxLength(field));
			}
			else if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.Population)
			{
				this.Population = GlobalValues.SetValueHelperIntNullableInternal(newValue);
			}
			else if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.State)
			{
				this.State = GlobalValues.SetValueHelperInternal((string)newValue, fixLength, GetMaxLength(field));
			}
			else if (field == Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants.ZipId)
			{
		...
		public static int DeleteData(Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, bool>> where)
		{
		...
		/// <returns>The number of rows deleted</returns>
		public static int DeleteData(Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, bool>> where, QueryOptimizer optimizer)
		{
		...
		/// <returns>The number of rows deleted</returns>
		public static int DeleteData(Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, bool>> where, string connectionString)
		{
		...
		/// <param name="connectionString">The database connection string to use for this access</param>
		/// <returns>The number of rows deleted</returns>
		public static int DeleteData(Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, bool>> where, QueryOptimizer optimizer, ContextStartup startup, string connectionString)
		{
			if (optimizer == null)
			...
			using (var connection = Gravitybox.GeoLocation.EFDAL.DBHelper.GetConnection(Gravitybox.GeoLocation.EFDAL.Util.StripEFCS2Normal(connectionString)))
			{
				...
				{
					var template = dc.GetTable<Gravitybox.GeoLocation.EFDAL.ZipQuery>();
					using (var cmd = BusinessEntityQuery.GetCommand<Gravitybox.GeoLocation.EFDAL.ZipQuery>(dc, template, where))
					{
		...
		public static int UpdateData<TSource>(Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, TSource>> select, Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, bool>> where, TSource newValue)
		{
			return BusinessObjectQuery<Gravitybox.GeoLocation.EFDAL.Entity.Zip, Gravitybox.GeoLocation.EFDAL.ZipQuery, TSource>.UpdateData(select: select, where: where, newValue: newValue, leafTable: "Zip", getField: GetDatabaseFieldName, hasModifyAudit: true);
		}
		...
		/// <returns>The number of records affected</returns>
		public static int UpdateData<TSource>(Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, TSource>> select, Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, bool>> where, TSource newValue, System.Data.IDbConnection connection, System.Data.Common.DbTransaction transaction)
		{
			return BusinessObjectQuery<Gravitybox.GeoLocation.EFDAL.Entity.Zip, Gravitybox.GeoLocation.EFDAL.ZipQuery, TSource>.UpdateData(select: select, where: where, newValue: newValue, leafTable: "Zip", getField: GetDatabaseFieldName, hasModifyAudit: true, startup: null, connection: connection, transaction: transaction);
		}
		...
		/// <returns>The number of records affected</returns>
		public static int UpdateData<TSource>(Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, TSource>> select, Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, bool>> where, TSource newValue, ContextStartup startup, string connectionString)
		{
			return BusinessObjectQuery<Gravitybox.GeoLocation.EFDAL.Entity.Zip, Gravitybox.GeoLocation.EFDAL.ZipQuery, TSource>.UpdateData(select: select, where: where, newValue: newValue, leafTable: "Zip", getField: GetDatabaseFieldName, hasModifyAudit: true, startup: startup, connectionString: connectionString);
		}
		...
		/// <param name="connectionString">The database connection string</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData<TSource>(Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, TSource>> select, Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, bool>> where, TSource newValue, string connectionString)
		{
			return BusinessObjectQuery<Gravitybox.GeoLocation.EFDAL.Entity.Zip, Gravitybox.GeoLocation.EFDAL.ZipQuery, TSource>.UpdateData(select: select, where: where, newValue: newValue, leafTable: "Zip", getField: GetDatabaseFieldName, hasModifyAudit: true, connectionString: connectionString);
		}
		...
		/// <param name="newValue">The new value to set the specified field in all matching records</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData<TSource>(Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, TSource>> select, Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, bool>> where, Gravitybox.GeoLocation.EFDAL.Entity.Zip newValue)
		{
			return BusinessObjectQuery<Gravitybox.GeoLocation.EFDAL.Entity.Zip, Gravitybox.GeoLocation.EFDAL.ZipQuery, TSource>.UpdateData(select: select, where: where, newValue: newValue, leafTable: "Zip", getField: GetDatabaseFieldName, hasModifyAudit: true);
		}
		...
		/// <param name="connectionString">The database connection string</param>
		/// <returns>The number of records affected</returns>
		public static int UpdateData<TSource>(Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, TSource>> select, Expression<Func<Gravitybox.GeoLocation.EFDAL.ZipQuery, bool>> where, Gravitybox.GeoLocation.EFDAL.Entity.Zip newValue, string connectionString)
		{
			return BusinessObjectQuery<Gravitybox.GeoLocation.EFDAL.Entity.Zip, Gravitybox.GeoLocation.EFDAL.ZipQuery, TSource>.UpdateData(select: select, where: where, newValue: newValue, leafTable: "Zip", getField: GetDatabaseFieldName, hasModifyAudit: true, connectionString: connectionString);
		}
		...
		/// </summary>
		internal static string GetDatabaseFieldName(Gravitybox.GeoLocation.EFDAL.Entity.Zip.FieldNameConstants field)
		{
		...
		{
			var other = obj as Gravitybox.GeoLocation.EFDAL.Entity.Zip;
...
namespace Gravitybox.GeoLocation.EFDAL.Entity.Metadata
{
	...
	/// </summary>
	[System.CodeDom.Compiler.GeneratedCode("nHydrateModelGenerator", "6.0.0")]
	public partial class ZipMetadata : Gravitybox.GeoLocation.EFDAL.IMetadata
	{
		#region Properties
