...
{
	#region LocationServiceEntitiesExtensions

	/// <summary>
	/// Extension methods for this library
	/// </summary>
	[System.CodeDom.Compiler.GeneratedCode("nHydrateModelGenerator", "6.0.0")]
	public static partial class LocationServiceEntitiesExtensions
	{
		#region Include Extension Methods

		private static System.Data.Entity.Infrastructure.DbQuery<T> GetInclude<T, R>(this System.Data.Entity.Infrastructure.DbQuery<T> item, Expression<Func<R, Gravitybox.LocationService.EFDAL.IContextInclude>> query)
			where T : BaseEntity
		...
		private static IQueryable<T> GetInclude<T, R>(this IQueryable<T> item, Expression<Func<R, Gravitybox.LocationService.EFDAL.IContextInclude>> query)
			where T : BaseEntity
			where R : IContextInclude
		{
		...
		/// </summary>
		public static System.Type GetFieldType(this Gravitybox.LocationService.EFDAL.LocationServiceEntities context, Enum field)
		{
			if (field is Gravitybox.LocationService.EFDAL.Entity.State.FieldNameConstants)
				return Gravitybox.LocationService.EFDAL.Entity.State.GetFieldType((Gravitybox.LocationService.EFDAL.Entity.State.FieldNameConstants)field);
			if (field is Gravitybox.LocationService.EFDAL.Entity.Zip.FieldNameConstants)
				return Gravitybox.LocationService.EFDAL.Entity.Zip.GetFieldType((Gravitybox.LocationService.EFDAL.Entity.Zip.FieldNameConstants)field);
		...
		public static Gravitybox.LocationService.EFDAL.IMetadata GetMetaData(this Gravitybox.LocationService.EFDAL.IReadOnlyBusinessObject entity)
		{
			...
			return Activator.CreateInstance(t) as Gravitybox.LocationService.EFDAL.IMetadata;
		}
		...
		public static System.Type GetEntityType(EntityMappingConstants entityType)
		{
			switch (entityType)
			{
				case EntityMappingConstants.State: return typeof(Gravitybox.LocationService.EFDAL.Entity.State);
				case EntityMappingConstants.Zip: return typeof(Gravitybox.LocationService.EFDAL.Entity.Zip);
			}
		...
		public static System.Collections.ObjectModel.ObservableCollection<T> AsObservable<T>(this System.Collections.Generic.IEnumerable<T> list)
			where T : Gravitybox.LocationService.EFDAL.IReadOnlyBusinessObject
		{
		...
		public static void Delete<T>(this IQueryable<T> query)
			where T : Gravitybox.LocationService.EFDAL.IBusinessObject, new()
		{
			...
			where T : Gravitybox.LocationService.EFDAL.IBusinessObject, new()
		{
			...
			else if (typeof(T) == typeof(Gravitybox.LocationService.EFDAL.Entity.State))
			{
				...
				sb.AppendLine(((IQueryable<Gravitybox.LocationService.EFDAL.Entity.State>)query).Select(x => new { x.StateId }).ToString());
				sb.AppendLine(") AS [Extent2]");
				sb.AppendLine("on [X].[StateId] = [Extent2].[StateId]");
				sb.AppendLine("select @@ROWCOUNT");
			}
			else if (typeof(T) == typeof(Gravitybox.LocationService.EFDAL.Entity.Zip))
			{
				sb.AppendLine("set rowcount " + optimizer.ChunkSize + ";");
				sb.AppendLine("delete [X] from [dbo].[Zip] [X] inner join (");
				sb.AppendLine(((IQueryable<Gravitybox.LocationService.EFDAL.Entity.Zip>)query).Select(x => new { x.ZipId }).ToString());
				sb.AppendLine(") AS [Extent2]");
			...
			#endregion
			if (string.IsNullOrEmpty(connectionString))
				connectionString = LocationServiceEntities.GetConnectionString();
		...
		public static void Delete<T>(this System.Data.Entity.DbSet<T> entitySet, Expression<Func<T, bool>> where)
			where T : class, Gravitybox.LocationService.EFDAL.IBusinessObject, new()
		{
		...
		public static void Delete<T>(this System.Data.Entity.DbSet<T> entitySet, Expression<Func<T, bool>> where, QueryOptimizer optimizer)
			where T : System.Data.Entity.DbSet<T>, Gravitybox.LocationService.EFDAL.IBusinessObject, new()
		{
