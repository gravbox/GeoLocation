...
namespace Gravitybox.LocationService.EFDAL
{
	...
	public partial class LocationServiceEntities : System.Data.Entity.DbContext, Gravitybox.LocationService.EFDAL.ILocationServiceEntities, IContext
	{
		...
		/// <summary />
		[field:NonSerialized]
		public event EventHandler<Gravitybox.LocationService.EFDAL.EventArguments.EntityListEventArgs> BeforeSaveModifiedEntity;
		/// <summary />
		protected virtual void OnBeforeSaveModifiedEntity(Gravitybox.LocationService.EFDAL.EventArguments.EntityListEventArgs e)
		{
		...
		/// <summary />
		[field:NonSerialized]
		public event EventHandler<Gravitybox.LocationService.EFDAL.EventArguments.EntityListEventArgs> BeforeSaveAddedEntity;
		/// <summary />
		protected virtual void OnBeforeSaveAddedEntity(Gravitybox.LocationService.EFDAL.EventArguments.EntityListEventArgs e)
		{
		...
		/// <summary />
		[field:NonSerialized]
		public event EventHandler<Gravitybox.LocationService.EFDAL.EventArguments.EntityListEventArgs> AfterSaveModifiedEntity;
		/// <summary />
		protected virtual void OnAfterSaveModifiedEntity(Gravitybox.LocationService.EFDAL.EventArguments.EntityListEventArgs e)
		{
		...
		/// <summary />
		[field:NonSerialized]
		public event EventHandler<Gravitybox.LocationService.EFDAL.EventArguments.EntityListEventArgs> AfterSaveAddedEntity;
		/// <summary />
		protected virtual void OnAfterSaveAddedEntity(Gravitybox.LocationService.EFDAL.EventArguments.EntityListEventArgs e)
		{
		...
		/// <summary>
		/// Initializes a new LocationServiceEntities object using the connection string found in the 'LocationServiceEntities' section of the application configuration file.
		/// </summary>
		public LocationServiceEntities() :
			base(Util.ConvertNormalCS2EFFromConfig("name=LocationServiceEntities"))
		{
		...
		/// <summary>
		/// Initialize a new LocationServiceEntities object with an audit modifier.
		/// </summary>
		public LocationServiceEntities(ContextStartup contextStartup) :
			base(Util.ConvertNormalCS2EFFromConfig("name=LocationServiceEntities", contextStartup))
		{
			InstanceKey = Guid.NewGuid();
		...
		/// Initialize a new LocationServiceEntities object with an audit modifier.
		/// </summary>
		public LocationServiceEntities(ContextStartup contextStartup, string connectionString) :
		...
		/// <summary>
		/// Initialize a new LocationServiceEntities object.
		/// </summary>
		public LocationServiceEntities(string connectionString) :
		...
		protected override void OnModelCreating(DbModelBuilder modelBuilder)
		{
			...
			Database.SetInitializer(new CustomDatabaseInitializer<LocationServiceEntities>());
			...
			#region Map Tables
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.State>().ToTable("State", "dbo");
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.Zip>().ToTable("Zip", "dbo");
			#endregion

			#region Setup Fields

			//Field setup for State entity
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.State>().Property(d => d.Abbr).IsRequired().HasMaxLength(2).HasColumnType("VARCHAR");
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.State>().Property(d => d.Description).IsOptional().HasMaxLength(1000).HasColumnType("VARCHAR");
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.State>().Property(d => d.Name).IsRequired().HasMaxLength(128).HasColumnType("VARCHAR");
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.State>().Property(d => d.StateId).IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.Identity);
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.State>().Property(d => d.TimeStamp).IsConcurrencyToken(true);

			//Field setup for Zip entity
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.Zip>().Property(d => d.City).IsRequired().HasMaxLength(50).HasColumnType("VARCHAR");
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.Zip>().Property(d => d.Latitude).IsOptional();
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.Zip>().Property(d => d.Longitude).IsOptional();
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.Zip>().Property(d => d.Name).IsRequired().HasMaxLength(10).HasColumnType("VARCHAR");
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.Zip>().Property(d => d.Population).IsOptional();
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.Zip>().Property(d => d.State).IsRequired().HasMaxLength(50).HasColumnType("VARCHAR");
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.Zip>().Property(d => d.ZipId).IsRequired().HasDatabaseGeneratedOption(System.ComponentModel.DataAnnotations.Schema.DatabaseGeneratedOption.Identity);
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.Zip>().Property(d => d.TimeStamp).IsConcurrencyToken(true);
			...
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.State>().HasKey(x => new { x.StateId });
			modelBuilder.Entity<Gravitybox.LocationService.EFDAL.Entity.Zip>().HasKey(x => new { x.ZipId });
		...
		/// </summary>
		public virtual DbSet<Gravitybox.LocationService.EFDAL.Entity.State> State { get; set; }

		/// <summary>
		/// Entity set for Zip
		/// </summary>
		public virtual DbSet<Gravitybox.LocationService.EFDAL.Entity.Zip> Zip { get; set; }
		...
		public virtual Gravitybox.LocationService.EFDAL.IBusinessObject AddItem(Gravitybox.LocationService.EFDAL.IBusinessObject entity)
		{
			if (entity == null) throw new NullReferenceException();
			var audit = entity as Gravitybox.LocationService.EFDAL.IAuditableSet;
			if (audit != null)
			{
			...
			if (false) { }
			else if (entity is Gravitybox.LocationService.EFDAL.Entity.State)
			{
				this.State.Add((Gravitybox.LocationService.EFDAL.Entity.State)entity);
			}
			else if (entity is Gravitybox.LocationService.EFDAL.Entity.Zip)
			{
				this.Zip.Add((Gravitybox.LocationService.EFDAL.Entity.Zip)entity);
			}
			return entity;
		}
		...
		internal static string GetConnectionString()
		{
			try
			{
				var a = System.Configuration.ConfigurationManager.ConnectionStrings["LocationServiceEntities"];
				if (a != null)
				{
		...
		/// <summary />
		IQueryable<Gravitybox.LocationService.EFDAL.Entity.State> Gravitybox.LocationService.EFDAL.ILocationServiceEntities.State
		{
			get { return this.State.AsQueryable(); }
		}

		/// <summary />
		IQueryable<Gravitybox.LocationService.EFDAL.Entity.Zip> Gravitybox.LocationService.EFDAL.ILocationServiceEntities.Zip
		{
		...
		{
			if (field is Gravitybox.LocationService.EFDAL.Entity.State.FieldNameConstants) return Gravitybox.LocationService.EFDAL.EntityMappingConstants.State;
			if (field is Gravitybox.LocationService.EFDAL.Entity.Zip.FieldNameConstants) return Gravitybox.LocationService.EFDAL.EntityMappingConstants.Zip;
		...
		/// </summary>
		public static Gravitybox.LocationService.EFDAL.IMetadata GetMetaData(Gravitybox.LocationService.EFDAL.EntityMappingConstants table)
		{
			switch (table)
			{
				case Gravitybox.LocationService.EFDAL.EntityMappingConstants.State: return new Gravitybox.LocationService.EFDAL.Entity.Metadata.StateMetadata();
				case Gravitybox.LocationService.EFDAL.EntityMappingConstants.Zip: return new Gravitybox.LocationService.EFDAL.Entity.Metadata.ZipMetadata();
			}
			throw new Exception("Entity not found!");
		}

		/// <summary />
		public static string GetTableName(Gravitybox.LocationService.EFDAL.EntityMappingConstants entity)
		{
	...
	internal class DbInterceptor : System.Data.Entity.Infrastructure.Interception.IDbCommandInterceptor
	{
		...
		void System.Data.Entity.Infrastructure.Interception.IDbCommandInterceptor.ReaderExecuting(System.Data.Common.DbCommand command, System.Data.Entity.Infrastructure.Interception.DbCommandInterceptionContext<System.Data.Common.DbDataReader> interceptionContext)
		{
			try
			{
				...
				if (LocationServiceEntities.QueryLogger != null)
				{
					var debugInfo = ((ILocationServiceEntities)(interceptionContext.DbContexts.First())).ContextStartup.DebugInfo;
					LocationServiceEntities.QueryLogger(debugInfo + "\r\n" + command.CommandText);
				}
			}
			catch { }
		}
